...
let CorporateService = class CorporateService {
    ...
    async update(id, updateData) {
        ...
        const { investigation_log, ...restOfUpdateData } = updateData;
        const { id: updateDtoId, contacts, subsidiaries, contactIdsToDelete, subsidiaryIdsToDelete, secondary_approver, ...corporateUpdateData } = restOfUpdateData;
    ...
    async handleCoolingPeriodCompletion(corporateId) {
        ...
        const secondaryApproverContact = corporate.contacts.find((contact) => contact.system_role === 'secondary_approver');
